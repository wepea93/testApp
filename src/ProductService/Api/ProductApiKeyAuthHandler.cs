...
{
    public class ProductApiKeyAuthHandler : AuthenticationHandler<AuthenticationSchemeOptions>
    {
        public const string ApiKeyHeaderName = "X-API-KEY";
        private readonly IConfiguration _configuration;

        public ProductApiKeyAuthHandler(
        ...
        protected override Task<AuthenticateResult> HandleAuthenticateAsync()
        {
            ...
            var configuredApiKey = _configuration["ApiKeys:ProductService"];
